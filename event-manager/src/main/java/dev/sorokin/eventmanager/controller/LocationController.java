...
public class LocationController {
    ...
    public LocationController(LocationService locationService, LocationWebMapper mapper) {
    ...
    public LocationResponseDto updateLocation(
        ...
        Location updatedLocation = locationService.updateLocation(locationId, source);
